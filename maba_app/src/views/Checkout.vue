...
export default {
  ...
  mounted(){
     stripe = window.Stripe('pk_test_51JYnT8G1mhdrEDUCvsIiCVXfjfMhKkwwdIXcI9PoINPgGcHBQCXjWpSSrBNNAisv3dbQ9Nj46DfHRqFC4Z3YhJmD00rXlc3Atg');
   ...
   async order(){
       const { paymentMethod } = await stripe.createPaymentMethod(
        'card', cardElement); 
            ...
            axios.post('/order',{paymentMethodId :paymentMethod.id}).then(data=>{
              console.log(data);
            });
